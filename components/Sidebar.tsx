        ...
        <div className="px-4 w-full relative">
          ...
          >
            <div className="relative shrink-0 flex items-center justify-center">
               <Settings size={24} className={`transition-transform duration-300 ${showSettings ? 'rotate-90 opacity-0' : ''}`} />
            ...
            {isExpanded && <span className="font-bold text-sm whitespace-nowrap animate-in fade-in duration-500">Settings</span>}
          </button>
        </div>
      </aside>
    </div>
